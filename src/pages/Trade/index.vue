  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="order in ShopList.detailArrayList"
          :key="order.skuId"
        >
          <li>
            <img
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ ShopList.totalAmount }}.00</span>
      </div>
  ...
  methods: {
    ...
    async submitList() {
      ...
      let data = {
        ...
        orderDetailList: this.ShopList.detailArrayList //商品清单
      };
      let result = await this.$API.reqSubmitList(tradeNo,data);
      if(result.code == 200){
